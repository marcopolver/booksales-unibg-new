...
\begin{document}
	...
	\begin{algorithm}[H]
		\KwData{request}
		\KwResult{nuovo User e nuovo StudentProfile salvati nel database }
		initialization\;
		\eIf{request.type = 'POST'}{
			creazione user\_form\;
			creazione student\_form\;
			ricezione dati utente\;
			
			\If{user\_form valido \textbf{and} student\_form valido}{
				
				user $\gets$ user\_form.data\;
				student $\gets$ student\_form.data\;
				student.user $\gets$ user\;
				\textbf{return} login page \;
			}
		}{
			user $\gets$ user\_form.data\;
			student $\gets$ student\_form.data\;
	...
	\begin{algorithm}[H]
		\KwData{username, major, year of study, User objects, StudentProfile objects}
		\KwResult{list of compatible students}
		initialization\;
	...
	\begin{algorithm}[H]
		\KwData{title name, quality class, starting price, ending price, Title objects, BookAd objects}
		\KwResult{list of compatible ads}
		initialization\;
