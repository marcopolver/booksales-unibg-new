...
\begin{document}
	...
	\subsection{UC12: Visualizzazione annunci consigliati}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC13: Inserimento annuncio libro in vendita}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC14: Inserimento nuovo titolo}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC15: Modifica annuncio libro in vendita}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC16: Notifica avvenuta vendita libro}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC17: Recensione studente}
	\subsubsection{UC17.1: Recensione acquirente}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsubsection{UC17.2: Recensione venditore}
	\begin{tabular}{lp{0.8\textwidth}}
	...
	\subsection{UC18: Conferma acquisto libro}
	\begin{tabular}{lp{0.8\textwidth}}
		\textbf{Descrizione}&Uno studente nel ruolo di acquirente vuole recensire il venditore di un libro precedentemente acquistato.\\
		\\
